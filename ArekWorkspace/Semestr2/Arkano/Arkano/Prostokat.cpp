...
Prostokat::Prostokat(double dlugosc, double wysokosc, double speed) : Figura(speed), _dlugosc(dlugosc), _wysokosc(wysokosc)
{
	this->setGeometria(_x, _y, 1.0*-dlugosc / 2, 1.0*-wysokosc / 2, 1.0* dlugosc / 2, 1.0* wysokosc / 2);
}
